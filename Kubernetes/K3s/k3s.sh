...
echo -e " \033[33;5m     ___           ___           ___      \033[0m"
echo -e " \033[33;5m    /__/|         /  /\         /  /\     \033[0m"
echo -e " \033[33;5m   |  |:|        /  /::\       /  /:/_    \033[0m"
echo -e " \033[33;5m   |  |:|       /  /:/\:\     /  /:/ /\   \033[0m"
echo -e " \033[33;5m __|  |:|      /  /:/~/::\   /  /:/ /::\  \033[0m"
echo -e " \033[33;5m/__/\_|:|____ /__/:/ /:/\:\ /__/:/ /:/\:\ \033[0m"
echo -e " \033[33;5m\  \:\/:::::/ \__\/ /:/~/:/ \  \:\/:/~/:/ \033[0m"
echo -e " \033[33;5m \  \::/~~~~    /__/:/ /:/   \  \::/ /:/  \033[0m"
echo -e " \033[33;5m  \  \:\        \__\/ /:/     \__\/ /:/   \033[0m"
echo -e " \033[33;5m   \  \:\         /__/:/        /__/:/    \033[0m"
echo -e " \033[33;5m    \__\/         \__\/         \__\/     \033[0m"
echo -e " \033[33;5m Referenced from => JamesTurland/JimsGarage \033[0m"
...
worker1=192.168.0.54
worker2=192.168.0.55
...
k3sup install \
  ...
  --k3s-extra-args "--docker --disable traefik --disable servicelb --flannel-iface=$interface --node-ip=$master1 --node-taint node-role.kubernetes.io/master=true:NoSchedule" \
  --merge \
  --sudo \
...
for newnode in "${masters[@]}"; do
  k3sup join \
    ...
    --server-ip $master1 \
    --ssh-key $HOME/.ssh/$certName \
    --k3s-extra-args "--docker --disable traefik --disable servicelb --flannel-iface=$interface --node-ip=$newnode --node-taint node-role.kubernetes.io/master=true:NoSchedule" \
    --server-user $user
